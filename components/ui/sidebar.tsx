...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-muted/40 relative flex w-full flex-1 flex-col overflow-hidden",
        "md:rounded-xl md:border md:shadow-sm md:my-2 md:mr-2 md:max-h-[calc(100svh-1rem)]",
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col p-4 group-data-[collapsible=icon]:px-2", className)}
      {...props}
    />
  )
}
